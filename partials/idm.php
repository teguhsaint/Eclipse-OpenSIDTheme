						...
						<div class="row">
							<div class="col-lgs-3 col-xs-6 status-idm-kiri">
								<div class="small-box bg-primary">
									...
									<div class="icon">
										<i class="ion ion-arrow-graph-up-right" style="color: #000"></i>
									</div>
								</div>
							</div>
							<div class="col-lgs-3 col-xs-6 status-idm-kiri status-idm-kanan">
								<div class="small-box bg-warning">
									...
									<div class="icon">
										<i class="ion-ios-pulse-strong" style="color: #000"></i>
									</div>
								</div>
							</div>
							<div class="col-lgs-3 col-xs-6 status-idm-kiri status-idm-kanan">
								<div class="small-box bg-success">
									...
									<div class="icon">
										<i class="ion ion-stats-bars" style="color: #000"></i>
									</div>
								</div>
							</div>
							<div class="col-lgs-3 col-xs-6 status-idm-kanan">
								<div class="small-box bg-danger">
									...
									<div class="icon">
										<i class="ion ion-ios-pie" style="color: #000"></i>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
									...
									<div class="col-sm-5">
										<!-- Tabel Data -->
											...
											<table class="table table-bordered table-striped dataTable table-hover" style="margin-left: auto; margin-right: auto">
												<tbody>
													<tr>
															<tr>
																<th >PROVINSI</th>
															...
															<tr>
																<th ><?= strtoupper($this->setting->sebutan_kecamatan) ?></th>
									...
									<div class="col-sm-6">
										<figure class="highcharts-figure" style="margin-left: auto; margin-right: auto">
