...
<meta name='theme' content='eclipse' />
<meta name='designer' content='Teguh Saint' />
<meta name='theme:designer' content='Teguh Saint' />
<meta name='theme:version' content='<?= THEME_VERSION ?>' />
<meta name="theme-color" content="#efefef">
<meta name='keywords' content="Sistem Informasi <?= $desa_title ?> Kecamatan <?= $desa['nama_kecamatan']; ?> Kabupaten <?= $desa['nama_kabupaten']; ?>, web desa, opensid, opensid eclipse, website desa, Website <?= $desa_title ?> Kecamatan <?= $desa['nama_kecamatan']; ?> Kabupaten <?= $desa['nama_kabupaten']; ?>" />
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/id_ID/sdk.js#xfbml=1&version=v10.0" nonce="u3UQkZfS"></script>
